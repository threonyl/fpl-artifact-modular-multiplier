...
# mapped transaction.
transferSize=1024 # 4K
#transferSize=2048 # 8 KB
#transferSize=4096 # 16 KB
...
echo "[INFO] Run test on $xdma_device"
...
for ((i=0; i<=3; i++)); do
	...
	echo "[INFO] channelId $channelId"
	echo "[INFO] streamEnable $streamEnable"
	...
	echo "[INFO] isStreaming $isStreaming"
done
